...
export default function Home() {
  ...
  const fetchExpenses = () => {
    ...
    fetch(`${API}/expenses/?limit=5${userId ? `&user_id=${userId}` : ""}`)
      .then(r => r.json())
  ...
  return (
    <>
      ...
      <div className="card">
        ...
        {expenses.length === 0 ? (
          <div className="empty-state">
            ...
            <p className="empty-state-text">No expenses yet. Add your first one!</p>
          </div>
        ) : (
      ...
      <ExpenseForm isOpen={showForm} onClose={handleFormClose} onSaved={() => {
        fetchExpenses();
